...
const Search = React.forwardRef<HTMLInputElement, props>((props, ref,) => {
  ...
  return (
    <div className="flex m-4 relative">
        ...
        className={`bg-transparent w-64 bg-opacity-35 bg-black outline-none border border-gray-600 focus:border-pink-500 hover:border-pink-500 text-gray-300 focus:text-pink-300 hover:text-pink-400 rounded-md text-center p-2 uppercase `}
      />
    </div>
  );
});
